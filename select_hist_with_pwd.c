...
//Поиск директории пользователя
//Склеим директорию пользователя и .bash_history
struct passwd *pw = getpwuid(getuid());
char * way_user = pw->pw_dir;
char way_to_bash_history[20]="/.bash_history";
char bhist[50];
snprintf(bhist, 50, "%s%s", way_user, way_to_bash_history);
